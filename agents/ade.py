...
T_out   = [];
txt_out = [];
raiz    = '/Users/maxtong/Desktop/Revised total';
...
% example = customreader('/Volumes/DRIVE #27/Samir Gouin/Revised total/10/rev0000058.png')

images_training = imageDatastore([raiz],"ReadFcn",@customreader,'IncludeSubfolders',true,'LabelSource','foldernames');
% image_training.ReadFcn = @customreader
images_training
% images_training = customreader(images_training)
...
tenth_stats     = sum(validationImages.Labels(aux) == '10')/sum(validationImages.Labels     == '10')
eleventh_stats     = sum(validationImages.Labels(aux) == '11')/sum(validationImages.Labels     == '11')
twelth_stats     = sum(validationImages.Labels(aux) == '12')/sum(validationImages.Labels     == '12')
thirteenth_stats     = sum(validationImages.Labels(aux) == '13')/sum(validationImages.Labels     == '13')
fifteenth_stats     = sum(validationImages.Labels(aux) == '15')/sum(validationImages.Labels     == '15')
second_stats     = sum(validationImages.Labels(aux) == '2')/sum(validationImages.Labels     == '2')
third_stats     = sum(validationImages.Labels(aux) == '3')/sum(validationImages.Labels     == '3')
fourth_stats     = sum(validationImages.Labels(aux) == '4')/sum(validationImages.Labels     == '4')
fifth_stats     = sum(validationImages.Labels(aux) == '5')/sum(validationImages.Labels     == '5')
sixth_stats     = sum(validationImages.Labels(aux) == '6')/sum(validationImages.Labels     == '6')
seventh_stats     = sum(validationImages.Labels(aux) == '7')/sum(validationImages.Labels     == '7')
eigth_stats     = sum(validationImages.Labels(aux) == '8')/sum(validationImages.Labels     == '8')
ninth_stats     = sum(validationImages.Labels(aux) == '9')/sum(validationImages.Labels     == '9')
...
images                    = imageDatastore([raiz], "ReadFcn", @customreader,'IncludeSubfolders',true);
